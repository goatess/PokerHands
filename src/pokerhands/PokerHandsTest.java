...
public class PokerHandsTest {
    ...
    public void get_royal_flush_score() {
        ...
        assertEquals(Ranking.ROYAL_FLUSH, handScore.getWinnerRanking());
    ...
    public void get_flush_score() {
        ...
        assertEquals(Ranking.FLUSH, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_straight_flush_score() {
        ...
        assertEquals(Ranking.STRAIGHT_FLUSH, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_straight_score() {
        ...
        assertEquals(Ranking.STRAIGHT, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_royal_straight_score() {
        ...
        assertEquals(Ranking.ROYAL_STRAIGHT, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_HIGH_CARD_score() {
        ...
        assertEquals(Ranking.HIGH_CARD, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    ...
    public void get_ONE_PAIR_score() {
        ...
        assertEquals(Ranking.ONE_PAIR, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_TWO_PAIR_score() {
        ...
        assertEquals(Ranking.TWO_PAIR, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_three_of_a_kind_score() {
        ...
        assertEquals(Ranking.THREE_OF_A_KIND, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_four_of_a_kind_score() {
        ...
        assertEquals(Ranking.FOUR_OF_A_KIND, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    public void get_full_house_score() {
        ...
        assertEquals(Ranking.FULL_HOUSE, handScore.getWinnerRanking());
        assertEquals(HAND, handScore.toString());
    }
    ...
    @Test
    public void flush_hand_wins_over_high_card(){
        final String RANKING = "\nWinner: 2C 4C 5C 7C 9C Flush (WINNER)\nLoser: 5D 2S 7C TS 9D High Card";
        ...
        loser.putCardsToHand(dealer.getDeck().drawCards(13, 3, 20, 35, 29));
